...
from mmpfn.models.dino_v2.eval.log_regression import get_args_parser as get_log_regression_args_parser
from mmpfn.models.dino_v2.logging import setup_logging
from mmpfn.models.dino_v2.run.submit import get_args_parser, submit_jobs
...
class Evaluator:
    ...
    def __call__(self):
        from mmpfn.models.dino_v2.eval.log_regression import main as log_regression_main
