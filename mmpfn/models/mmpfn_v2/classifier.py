...
from mmpfn.models.mmpfn_v2.base import (
    create_inference_engine,
    determine_precision,
    initialize_mmpfn_model,
)
from mmpfn.models.mmpfn_v2.constants import (
...
from mmpfn.models.mmpfn_v2.preprocessing import (
    ClassifierEnsembleConfig,
    EnsembleConfig,
    default_classifier_preprocessor_configs,
)
from mmpfn.models.mmpfn_v2.utils import (
    _fix_dtypes,
...
if TYPE_CHECKING:
    ...
    from mmpfn.models.mmpfn_v2.inference import (
        InferenceEngine,
    )
    from mmpfn.models.mmpfn_v2.model.config import InferenceConfig
...
class MMPFNClassifier(ClassifierMixin, BaseEstimator):
    """MMPFNClassifier class."""
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        """A MMPFN interface for classification.
    ...
    def fit(self, X: XType, image: np.ndarray, y: YType) -> Self:
        ...
        self.model_, self.config_, _ = initialize_mmpfn_model(
    ...
    def predict(self, X: XType, X_image: np.ndarray) -> np.ndarray:
        ...
        """
        proba = self.predict_proba(X, X_image)
        y = np.argmax(proba, axis=1)
        return self.label_encoder_.inverse_transform(y)  # type: ignore

    def predict_proba(self, X: XType, image_test: np.ndarray) -> np.ndarray:
