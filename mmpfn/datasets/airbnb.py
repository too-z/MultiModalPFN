...
class AirbnbDataset(Dataset):
    def __init__(self, data_path):
        ...
        self.cat_features = ['host_location', 'host_since_year','host_is_superhost', 'host_neighborhood', 'host_has_profile_pic', 'host_identity_verified', 'neighborhood', 'city', 'smart_location', 'suburb', 'state', 'is_location_exact', 'property_type', 'room_type', 'bed_type', 'instant_bookable', 'cancellation_policy', 'require_guest_profile_picture', 'require_guest_phone_verification', 'host_response_time', 'calendar_updated', 'host_verifications', 'last_review_year']
        num_features = ['host_response_rate', 'latitude', 'longitude', 'accommodates', 'bathrooms', 'bedrooms', 'beds', 'security_deposit', 'cleaning_fee', 'guests_included', 'extra_people', 'minimum_nights', 'maximum_nights', 'availability_30', 'availability_60', 'availability_90', 'availability_365', 'number_of_reviews', 'review_scores_rating', 'review_scores_accuracy', 'review_scores_cleanliness', 'review_scores_checkin', 'review_scores_communication', 'review_scores_location', 'review_scores_value', 'calculated_host_listings_count', 'reviews_per_month']
        ...
        df[text_features] = df['name'] + ' ' + df['summary']+ ' ' + df['description']
